...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO saveProduct(
        ...
        LOGGER.info("[saveProduct] Entity 객체를 DTO 객체로 변환 작업. getProductPrice : {}" + productEntity.getProductPrice());
        ...
        LOGGER.info("[saveProduct productEntity.getProductPrice() : " + productEntity.getProductPrice());
        LOGGER.info("[saveProduct productEntity.getProductStock() : " + productEntity.getProductStock());
